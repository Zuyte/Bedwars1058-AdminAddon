        ...
        if (sender instanceof Player) {
            ...
            if (args.length == 0) {
                ...
                if (args[0].equalsIgnoreCase("help")) {
                    ...
                    new ForceJoinSubCommand().player(p, args);
                    return true;
        ...
        if (sender instanceof ConsoleCommandSender) {
            ...
            if (args.length >= 1) {
                if (args[0].equalsIgnoreCase("help")) {
                    ...
                    new ForceJoinSubCommand().console(c, args);
                    return true;
                } else if (args[0].equalsIgnoreCase("setteam")) {
                    new SetTeamSubCommand().console(c, args);
                    return true;
                } else if (args[0].equalsIgnoreCase("setbed")) {
                    new SetBedSubCommand().console(c, args);
                    return true;
                } else if (args[0].equalsIgnoreCase("skipevent")) {
                    new SkipEventSubCommand().console(c, args);
                    return true;
                } else if (args[0].equalsIgnoreCase("nextevent")) {
                    new NextEventSubCommand().console(c, args);
                    return true;
//                } else if (args[0].equalsIgnoreCase("revive")) {
//                    new revive().console(c, args);
//                    return true;
                } else if (args[0].equalsIgnoreCase("troll")) {
                    new TrollSubCommand().console(c, args);
                    return true;
                }
